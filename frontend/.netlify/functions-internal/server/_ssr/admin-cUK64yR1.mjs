...
import { I as InternalLayout, A as ADMIN_NAV } from "./admin-nav-BqOKdITv.mjs";
...
const SplitComponent = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(InternalLayout, { nav: ADMIN_NAV, title: "Admin Dashboard", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
};
export {
